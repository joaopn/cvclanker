...
const migrations: string[] = [
  ...
  // Whether the live check found an Easy Apply (on-LinkedIn) posting. Same
  // defensive-ALTER-before-rebuild pattern as the trio above; the rebuild's
  ...
  `INSERT INTO jobs_new (
    ...
    live_closed, live_applicants, live_easy_apply, live_status_checked_at,
